...
elif [ -f "/etc/xray/shadowsocks/config.json" ]; then
...
rm -f /etc/xray/shadowsocks/\$user /etc/xray/shadowsocks/\${user}IP /var/www/html/shadowsocks-\$user.txt 2>/dev/null || true
