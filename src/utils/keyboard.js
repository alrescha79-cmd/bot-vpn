...
exports.buildPaginatedKeyboard = buildPaginatedKeyboard;
exports.buildMainMenuKeyboard = buildMainMenuKeyboard;
exports.buildProtocolKeyboard = buildProtocolKeyboard;
exports.buildServerKeyboard = buildServerKeyboard;
...
function buildServerKeyboard(servers, protocol, action, page = 0) {
    ...
    return buildPaginatedKeyboard(servers, page, 8, buildButton, `navigate_${action}_${protocol}`);
}
/**
