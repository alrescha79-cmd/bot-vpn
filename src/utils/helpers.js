...
exports.resolveDomainToIP = resolveDomainToIP;
exports.getISPAndLocation = getISPAndLocation;
exports.generateRandomAmount = generateRandomAmount;
exports.safeSend = safeSend;
exports.formatUptime = formatUptime;
exports.sleep = sleep;
exports.isValidSQLiteDB = isValidSQLiteDB;
exports.isValidSQLDump = isValidSQLDump;
exports.calculateResellerLevel = calculateResellerLevel;
exports.getLevelPriority = getLevelPriority;
exports.getResellerDiscount = getResellerDiscount;
exports.getTrialLimit = getTrialLimit;
exports.cleanupOrphanResellers = cleanupOrphanResellers;
...
async function resolveDomainToIP(domain) {
    try {
        ...
        const addresses = await dns_1.promises.resolve4(cleanDomain);
        return addresses[0];
    }
    catch (err) {
